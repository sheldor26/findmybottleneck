...
the numbers that produced the answer. For the person who posts a screenshot of
a monitoring overlay on a forum and waits for a stranger to interpret it.

## Stack in one line

Python — details in [ARCHITECTURE.md](ARCHITECTURE.md).
